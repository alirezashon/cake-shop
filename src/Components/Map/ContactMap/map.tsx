  ...
  return (
    <div>
      ...
      >
        ...
        <Marker
          icon={defaultIcon}
          position={[35.74317452119071, 51.53338925046935]}
        >
          <Popup>
        ...
        <Marker
          icon={defaultIcon}
          position={[35.80825859566543, 51.46232119283639]}
        >
          <Popup>
            A pretty CSS3 popup. <br /> Easily customizable.
          </Popup>
        </Marker>
        <Marker icon={defaultIcon} position={[35.7059676, 51.406375399999995]}>
          <Popup>
            A pretty CSS3 popup. <br /> Easily customizable.
          </Popup>
        </Marker>
